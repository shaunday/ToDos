...
namespace ToDos.HeadlessSimulators
{
    ...
    public class ScriptFileParser
    {
        ...
        {
            System.IO.File.AppendAllText("crash_diag.txt", $"[ScriptFileParser.Parse] Entry {filePath} {DateTime.Now}\n");
            ...
            System.IO.File.AppendAllText("crash_diag.txt", $"[ScriptFileParser.Parse] Exit {filePath} {DateTime.Now}\n");
